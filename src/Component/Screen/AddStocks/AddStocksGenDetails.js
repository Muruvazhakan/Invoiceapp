...
const AddStocksGenDetails = (props) => {
  ...
  const autocompleTitle = () => {
    if (stockdet.clientList !== null && stockdet.clientList.length > 0) {
      ...
      console.log("unique autocompleTitle");
                  ...
                  {stockdet.stockid.length == 0 ? (
                    <div>
                      <Button
                        ...
                        variant="outlined"
                        endIcon={<FaRegIdCard />}
                        onClick={() => stockdet.dateHandler("stock")}
                      >
                        Generate Stock Id
                      </Button>{" "}
                    </div>
                    ...
                    <div className="invoicegen">
                      {" "}
                      Stock Id Generated: {stockdet.stockid}
                    </div>
                  )}
                  Bought date:
                  <input
                    ...
                    onChange={(e) => stockdet.setval(e, stockdet.setstockdate)}
                    title="payement"
                    size={210}
                    id="dateDefault"
                    value={stockdet.stockdate}
                    aria-label="stock"
                  />
                </>
              ) : (
                  ...
                  {stockdet.salestockid.length == 0 ? (
                    <div>
                      <Button
                        ...
                        variant="outlined"
                        endIcon={<FaRegIdCard />}
                        onClick={() => stockdet.dateHandler("sale")}
                      >
                        Generate Sale Stock Id
                      </Button>{" "}
                    </div>
                  ) : (
                    <div className="invoicegen">
                      {" "}
                      Sale Stock Id Generated: {stockdet.salestockid}
                    </div>
                  )}
                  Sale date:
                  <input
                    ...
                    className="date-field"
                    onChange={(e) =>
                      stockdet.setval(e, stockdet.setsalestockdate)
                    }
                    title="payement"
                    size={210}
                    id="dateDefault"
                    value={stockdet.salestockdate}
                    aria-label="salestock"
                  />
                </>
              )}
            </Box>
            ...
            >
              ...
              <div className="button-warn buttonspace">
                <Button
                  ...
                  onClick={() => stockdet.cleartallStock(props.screen)}
                >
                  {" "}
                  Reset Screen
                </Button>
