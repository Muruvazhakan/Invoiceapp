...
const EstimateTableForm = (props) => {
  ...
  const autocompleTitle = () => {
    if (
      estdetail.estimateHistoryData !== null &&
      estdetail.estimateHistoryData.length > 0
    ) {
      ...
      const ti = unique.map((allrows) => {
        return { title: allrows };
      });
      ...
      const sub = uniquesub.map((allrows) => {
        return { title: allrows };
      });
      console.log(sub);
      setit(ti);
        ...
        <FormGroup>
          <FormControl>
            <Card>
              ...
              >
                ...
                <TextField
                  ...
                  id="outlined-required"
                  label="Order number"
                  value={estdetail.orderno}
                  type="number"
                  onChange={(e) => setval(e, estdetail.setorderno)}
                  color={setboxColors(estdetail.orderno, "color")}
                  error={setboxColors(
                    () =>
                      estdetail.setisotheritem(!estdetail.isotheritem).orderno,
                    "error"
                  )}
                />
                <h4 className="tagline">
                  'Switch to Special item feature to add other than raw
                  material'{" "}
                </h4>
                <FormControlLabel
                  control={
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={() =>
                            estdetail.sethideotheritem(!estdetail.hideotheritem)
                          }
                          name="isotheritem"
                        />
                      }
                ...
                <h4 className="tagline">
                  {estdetail.isotheritem ? "Specail Item activated" : null}
                </h4>
                <h4 className="tagline">
                  {estdetail.hideotheritem
                    ? "Length, Height, Area, Total sq.ft will be hidden"
                    : null}
                </h4>
                <TextField
                  required
                ...
                <TextField
                  required
                  id="outlined-required"
                  label="Total Pvc cost"
                  value={estdetail.totalpvccost}
                  type="number"
                ...
                <TextField
                  required
                  id="outlined-required"
                  label="Total Upvc cost"
                  value={estdetail.totalupvccost}
                  type="number"
                ...
                <TextField
                  required
                  id="outlined-required"
                  label="Total Wood cost"
                  value={estdetail.totalwoodcost}
                  type="number"
                  ...
                  {estdetail.isNewDataSaveType ? (
                    <>
                      <Button
                        ...
                        endIcon={<BsSave />}
                        onClick={() =>
                          estdetail.addOrUpdateEstimateItemHandler(
                            "",
                            "",
                            "New"
                          )
            ...
            <Card>
              ...
              >
                ...
                <div className="companyname tagline ">
                  <div>
                    {!estdetail.columns[6].display && (
                      <>
                        {" "}
                        " PVC cost Psf & Total PVC Cost colums will not be
                        visible "
                      </>
                    )}
                  </div>
                  <div>
                    {" "}
                    {!estdetail.columns[8].display && (
                      <>
                        {" "}
                        "UPVC cost Psf & Total UPVC Cost colums will not be
                        visible"
                      </>
                    )}
                  </div>
                  <div>
                    {" "}
                    {!estdetail.columns[10].display && (
                      <>
                        "Wood cost Psf & Total Wood Cost colums will not be
                        visible"
                      </>
                    )}
                  </div>
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={() =>
                      estdetail.setdiscountedcheck(!estdetail.discountedcheck)
                    }
                    //  checked={tabledet.ischargedinhsn} onChange={() => tabledet.setischargedinhsn(!tabledet.ischargedinhsn)}
              ...
              >
                <TextField
                  required
                  id="outlined-required"
                  label="Discounted Text"
                  value={estdetail.discountedText}
                ...
                <TextField
                  required
                  id="outlined-required"
                  label="Discounted Total Pvc cost"
                  value={estdetail.discountedTotalpvccost}
                  type="number"
                  onChange={(e) =>
                    setval(e, estdetail.setdiscountedTotalpvccost)
                  }
                  color={setboxColors(
                    estdetail.discountedTotalpvccost,
                    "color"
                  )}
                  error={setboxColors(
                    estdetail.discountedTotalpvccost,
                ...
                <TextField
                  required
                  id="outlined-required"
                  label="Discounted Total Upvc cost"
                  value={estdetail.discountedTotalupvccost}
                  type="number"
                  onChange={(e) =>
                    setval(e, estdetail.setdiscountedTotalupvccost)
                  }
                  color={setboxColors(
                    estdetail.discountedTotalupvccost,
                    "color"
                  )}
                  error={setboxColors(
                    estdetail.discountedTotalupvccost,
                ...
                <TextField
                  required
                  id="outlined-required"
                  label="Discounted Total Wood cost"
                  value={estdetail.discountedTotalwoodcost}
                  type="number"
                  onChange={(e) =>
                    setval(e, estdetail.setdiscountedTotalwoodcost)
                  }
                  color={setboxColors(
                    estdetail.discountedTotalwoodcost,
                    "color"
                  )}
                  error={setboxColors(
                    estdetail.discountedTotalwoodcost,
            ...
            <div className="button-warn buttonspace">
              ...
              >
                Save Complete Estimate
              </Button>

              {estdetail.estimateid.length === 0 && (
                <div className="displaysmalldata">
                  {" "}
                  Estimate Id is not generates
                </div>
              )}
            </div>
            <div className="button-warn buttonspace">
              <Button
                ...
                onClick={() => estdetail.cleartallEstimateotal()}
              >
