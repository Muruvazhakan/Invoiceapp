...
const CompanyOtherDetailEdit = () => {
  ...
  return (
    <Card>
      ...
      <StyleHeader>Terms And Conditions</StyleHeader>
      {companydet.companydetails &&
          ...
          return (
            ...
            >
              <div className=" companyotherdeta companyindex" key={item.id}>
                <div className="companyindex ">{index + 1}</div>
                ...
                <FormControlLabel
                  ...
                  // label="Is Visible?"
                />
                <h5 className="tagline isvisible">
                ...
                <Button
                  ...
                  onClick={() =>
                    companydet.companyOtherDetailHandeler(item.id, "delete")
                  }
                >
                  Delete
                </Button>
      ...
      <Button
        ...
        onClick={() =>
          companydet.saveHandler(
            "addOrUpdateCompanyTermsAndConditionHandler",
            companydet.companydetails,
            "save"
          )
        }
      ...
      <Card>
        <StyleHeader>Add New Terms And Conditions</StyleHeader>
        ...
        >
          <div className=" companyotherdeta companyindex">
            <TextField
              id="outlined-required"
              label="Title"
              value={companydet.companydetailtitle}
              onChange={(e) => {
            ...
            <TextField
              ...
              label="Details"
              multiline
              value={companydet.companydetaildesc}
              onChange={(e) => {
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={companydet.companydetailIsVisible}
                  onChange={(e) => {
                    companydet.setcompanydetailIsVisible(
                      !companydet.companydetailIsVisible
                    );
                  }}
                  name="Visibility"
                />
