...
import ExpenseTracker from "../Screen/ExpenseTracker/ExpenseTracker";
            ...
            <Routes>
              {!logindet.loginstatus ? (
                ...
                <>
                  ...
                  <Route
                    path="/listofaddedstocks"
                    Component={ListOfAddedStocks}
                  />
                  <Route path="/geninvoice" Component={InvoiceMainComponent} />
                  <Route
                    path="/genestimate"
                    Component={EstimateMainComponent}
                  />
                  ...
                  <Route path="/login" Component={Login} />
                  <Route path="/expansetracker" Component={ExpenseTracker} />
